...
# sepalとpetalの面積
X['sepal_area'] = X['sepal length in cm'] * X['sepal width in cm']
X['petal_area'] = X['petal length in cm'] * X['petal width in cm']

# length/widthの割合
X['sepal_length/width'] = X['sepal length in cm'] / X['sepal width in cm']
X['petal_length/width'] = X['petal length in cm'] / X['petal width in cm']
...
# ファイルのエクスポート
sub.to_csv('./submit/iris_GNB.csv', header=None, index=None)    